...
const ServiceSubservices = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="text-center max-w-md px-6">
          ...
          <button 
            onClick={() => navigate('/')}
            className="px-8 py bg-gradient-to-r from-gray-900 to-black text-white rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 font-medium"
          >
            Back to Home
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-black pt-20 pb-20">
