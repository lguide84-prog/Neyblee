        ...
        <div className="mb-10">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-6">
            <div className="w-full md:w-auto md:flex-1">
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 text-gray-900 placeholder-gray-400"
                />
            ...
            <div className="flex gap-2">
              {['all', 'monthly', 'one-time', 'custom'].map((filter) => (
                <button
                  key={filter}
                ...
                >
                  {filter === 'all' ? 'All' : 
                   ...
                   filter === 'one-time' ? 'One-time' : 'Custom'}
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-500">
              Showing {filteredSubservices.length} of {service.subservices?.length} solutions
            </div>
            <div className="text-sm text-gray-900 font-medium">
              Sort by: <span className="text-gray-600">Recommended</span>
            </div>
          </div>
        </div>
              ...
              {filteredSubservices.map((subservice, index) => (
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    {!subservice.price.includes('Custom') && (
