    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={
          ...
          <Route path="/servic/:serviceId/subservices" element={<ServiceSubservices />} />
        {/* Service Detail Route */}
      <Route path="/subservice/:serviceId/detail/:subserviceId" element={<ServiceDetail />} />
        <Route path="/services/google-services/subservices" element={<ServiceSubservices serviceId="1" />} />
