    ...
    <>
      ...
      >
        ...
        >
          ...
          <button 
            onClick={handleMenuClick}
            className="absolute right-6 top-6 w-10 h-10 mt-10rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors z-10 close-btn"
          >
