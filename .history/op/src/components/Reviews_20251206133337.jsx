            ...
            <div ref={titleRef} className="inline-block">
              <div className="relative mb-10">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-8xl lg:text-9xl font-black opacity-5 tracking-tighter">
                    FEEDBACK
                  </div>
                </div>
                <h1 className="text-6xl lg:text-7xl font-bold relative z-10 tracking-tight">
                  REVIEWS
                </h1>
              </div>
