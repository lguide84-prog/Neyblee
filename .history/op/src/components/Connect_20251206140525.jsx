      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="h-[40vh] relative overflow-hidden bg-gradient-to-r from-emerald-900/30 to-cyan-900/30">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <button className="px-8 py-4  text-white font-bold rounded-full shadow-2xl hover:shadow-emerald-500/30 hover:scale-105 transition-all duration-300 animate-pulse-slow">
              CONNECT NOW
            </button>
          </div>
        </div>
