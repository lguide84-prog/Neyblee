...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black" ref={servicesRef}>
      {/* Hero Section */}
      <section className="pt-32 pb-20  lg:px-8">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-4 lg:py-8 flex items-center justify-between hover:bg-gray-50 transition-colors duration-300 group"
                >
                  <div className="flex items-start w-full">
                    ...
                    <div className="w-12 flex-shrink-0 flex items-center justify-center">
                      <div className={`w-18 h-13 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-black ${expandedIndex === index ? 'bg-black border-black' : ''}`}>
                        <svg 
                          className={`w-14 h-4 transition-transform duration-300 ${expandedIndex === index ? 'rotate-180 text-white' : 'text-gray-500 group-hover:text-black'}`}
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
