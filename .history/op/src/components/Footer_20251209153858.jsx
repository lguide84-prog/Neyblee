...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 overflow-hidden relative exo">
      {/* Gradient Accent */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="max-w-xs space-y-5">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-black leading-tight">Digital Express India<sup className="text-xs text-gray-600">®</sup></h3>
            ...
            <div className="flex space-x-3 pt-2">
              <a href="https://www.facebook.com/digitalexpressindiaa/" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-purple-600 transition-all duration-300 flex items-center justify-center group">
              ...
              <a href="https://www.instagram.com/digitalexpressindia/?hl=en" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-pink-600 transition-all duration-300 flex items-center justify-center group">
                <svg className="w-4 h-4 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/in/ravi-sharma-3b423452/?trk=public_profile_browsemap_profile-result-card_result-card_full-click&originalSubdomain=in" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-700 transition-all duration-300 flex items-center justify-center group">
                <svg className="w-4 h-4 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-xs">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start group">
                ...
                <div>
                  <p className="text-sm text-black font-medium">Flatno-1405 Tower-N Aditya World City, Near Wave City, Ghaziabad, 201002</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
              ...
              <Link to="/term" className="text-gray-600 hover:text-black transition-colors hover:underline">
                Terms of Service
              </Link>
              <span className="text-gray-400">•</span>
