    ...
    <div className="sticky -top-[10vh] lg:-top-30 flex items-center justify-center">
      ...
      >
        <div className="w-full h-full flex flex-col lg:flex-row gap-8">
          ...
          {/* Left Card - Ultra Minimal */}
          <a 
            href={leftProject.link} 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex-1 group relative bg-black flex items-center justify-center overflow-hidden"
          >
            {/* Single Line across screen */}
            ...
            <div className="relative z-10 text-center">
              <div className="space-y-0">
                <h3 className="text-white text-5xl lg:text-6xl font-light tracking-widest">
                  {leftProject.title}
                </h3>
                <h3 className="text-white/60 text-5xl lg:text-6xl font-light tracking-widest">
              ...
              <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="text-white/40 text-xs tracking-widest uppercase">
                  {leftProject.category} • {leftProject.year}
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="text-white/40 text-xs tracking-widest uppercase">
                  {rightProject.category} • {rightProject.year}
                </div>
              </div>
            </div>
