  ...
  <div className="text-white">
    <div className="flex flex-col items-center gap-8">
      ...
      <a 
        ...
        className="group"
      >
        <div className="w-13 h-10 rounded-full flex items-center justify-center transition-all duration-300 group-hover:border-white group-hover:bg-white/10 group-hover:scale-110">
