        ...
        <div className={`w-full py-4 lg:px-8 lg:py-4 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5'>
              ...
              <div 
                ref={servicesCardRef}
                className="fixed z-50 hidden bg-white rounded-xl mr-30 shadow-2xl overflow-hidden border border-gray-300"
              ...
              >
                ...
                <div className="w-64 bg-gray-50 border-r border-gray-200 left-[400px ">
                ...
                <div 
                  ref={subServicesRef}
                  className="w-64 bg-white border-r border-gray-200 overflow-y-auto hidden mr-20"
                >
