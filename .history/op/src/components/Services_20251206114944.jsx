    ...
    <div className="min-h-screen bg-white text-black" ref={servicesRef}>
      ...
      <section className="pt-32 pb-20 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div 
            ref={imageRef}
            className="fixed top-1/2 right-28 lg:right-38 w-[300px] h-[300px] z-40 pointer-events-none opacity-0 scale-95"
            style={{
                ...
                >
                  ...
                  <div className="flex items-start w-full ">
                    ...
                    <div className=" mr-2 w-12 flex-shrink-0 flex items-center justify-center">
                      <div className={` h-8 lg:w-18 lg:h-13 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-black ${expandedIndex === index ? 'bg-black border-black' : ''}`}>
                        <svg 
