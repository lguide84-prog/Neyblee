  ...
  <div className="relative h-full flex items-center justify-center">
    <button className="focus:outline-none">
      <CircularText
        ...
        showArrow={true}
        arrowSize="text-4xl" // Customize arrow size
      />
    </button>
    
    {/* Optional: Text below the circular text */}
    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-10 text-white/70 text-sm font-light">
      Scroll Down
    </div>
  </div>
</div>
