...
function Home() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="w-full h-[100vh] lg:h-[100vh] lg:py-4 lg:px-4">
            ...
            <div className="w-full max-w-6xl">
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="h-1/3 flex items-end justify-center lg:pb-8 w-full">
                  <h1 
                    ref={topTextRef}
                    className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-medium text-white text-center drop-shadow-2xl leading-tight lg:leading-[4.5rem] opacity-0"
                  >
                    SHAPING THE
                  </h1>
                </div>
                ...
                <div className="h-1/3 flex items-center justify-center w-full">
                  <h1 
                    ref={middleTextRef}
                    className="text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-medium text-white text-center drop-shadow-2xl leading-tight lg:leading-[5rem] opacity-0"
                  >
                    FUTURE WITH
                  </h1>
                </div>
                ...
                <div className="h-1/3 flex items-start justify-center lg:pt-8 w-full">
                  <h1 
                    ref={bottomTextRef}
                    className="text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-medium text-white text-center drop-shadow-2xl leading-tight lg:leading-[5.0rem] opacity-0"
                  >
                    SMART SOLUTIONS
                  </h1>
                </div>
