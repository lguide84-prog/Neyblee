                ...
                >
                  <div className="flex items-start w-full">
                    ...
                    <div className="flex-1 text-left">
                      {/* Main Service Title */}
                      <h3 className="text-4xl big lg:text-5xl font-bold mb-2 tracking-tight">
                        <TextRoll>
                          {service.title}
                        </TextRoll>
                      </h3>
                ...
                >
                  <div className="pb-12 pl-16">
                    ...
                    <div className="flex items-center gap-4">
                      <button className="px-6 py-2 bg-black text-white text-sm font-medium rounded-full hover:bg-gray-800 transition-colors duration-300">
                     Check
                      </button>
