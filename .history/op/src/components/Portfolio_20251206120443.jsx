    ...
    <div className="sticky -top-[10vh] lg:-top-30 flex items-center justify-center">
      ...
      >
        ...
        <div className="w-full h-full flex flex-col lg:flex-row gap-4 lg:gap-8">
          ...
          {/* Left Card - Geometric Design */}
          <a 
            href={leftProject.link} 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex-1 group relative overflow-hidden bg-black"
          >
            {/* Geometric Pattern Background */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-0 left-0 w-1/2 h-1/2 border-r border-b border-white/30"></div>
              <div className="absolute top-0 right-0 w-1/2 h-1/2 border-l border-b border-white/30"></div>
              <div className="absolute bottom-0 left-0 w-1/2 h-1/2 border-r border-t border-white/30"></div>
            ...
            <div className="absolute bottom-0 right-0 w-full h-px bg-white transform -rotate-45 origin-right"></div>

            {/* Content */}
            <div className="relative h-full p-6 lg:p-8 flex flex-col">
              {/* Number Indicator */}
              <div className="mb-4">
                <span className="text-white text-xs tracking-widest">0{i+1}</span>
              </div>

              {/* Title Stacked */}
              <div className="flex-1 flex items-center">
                <div className="space-y-2">
                  <h3 className="text-white text-3xl lg:text-4xl font-bold tracking-tight">
                    {leftProject.title}
                  </h3>
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-full h-px bg-white transform -rotate-45 origin-right"></div>
            <div className="absolute bottom-0 left-0 w-full h-px bg-white transform rotate-45 origin-left"></div>

            <div className="relative h-full p-6 lg:p-8 flex flex-col">
              <div className="mb-4">
                <span className="text-white text-xs tracking-widest">0{i+2}</span>
              </div>
