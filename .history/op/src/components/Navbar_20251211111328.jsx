  ...
  return (
    <>
      ...
      >
        ...
        {/* Menu Content */}
        <div 
          className="relative h-[90vh] w-full lg:h-[80vh] lg:w-[45vw] bg-white rounded-4xl overflow-hidden shadow-2xl transform-gpu mb-35 lg:mb-0 overflow-y-auto"
          style={{
            transformOrigin: 'bottom right'
          }}
        ...
        >
          ...
          <button 
            onClick={handleMenuClick}
            className="absolute right-6 top-6 w-10 h-10 mt-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors z-10 close-btn"
          >
