...
function Navbar({ isHomePage = false }) {
  ...
  return (
    <>
        ...
        <div className={`w-full py-1 lg:px-8 lg:py-1 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5 relative' ref={dropdownRef}>
              ...
              <div className="md:hidden"> {/* Added md:hidden class */}
                <button 
      ...
      <div 
        ref={menuOverlayRef}
        className="fixed inset-0 bg-black/80 backdrop-blur-sm z-40 hidden items-end justify-end px-4 md:hidden" // Added md:hidden here
      >
        <div 
