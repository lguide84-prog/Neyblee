  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className="relative h-[80vh] w-[45vw]   rounded-4xl overflow-hidden shadow-2xl transform-gpu "
          style={{
            transformOrigin: 'bottom right'
          }}
        >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative overflow-hidden">
                      <h3 className="text-black font-extrabold text-5xl lg:text-6xl font-light tracking-tight opacity-90 group-hover:opacity-100 transition-all duration-500">
                        {item.title}
                      </h3>
                      {/* Underline animation */}
