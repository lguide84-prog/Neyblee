  ...
  return (
    <nav className="w-full px-6 py-4 lg:px-8 lg:py-4 bg-[#0E0E0E] rounded-full">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-10 big text-lg">
          <a 
            href="#" 
            className="text-white font-medium  tracking-wide hover:text-blue-300 transition-colors duration-300 relative group"
          >
            HOME
