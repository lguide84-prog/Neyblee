                        ...
                        <div className="h-[calc(80vh-73px)] overflow-y-auto p-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {item.subServices.map((service, serviceIndex) => (
                              ...
                              >
                                {/* Service Card */}
                                <div className={`bg-gray-50 rounded-lg border ${activeSubDropdown === service.id ? 'border-blue-300 shadow-lg' : 'border-gray-200'} hover:border-blue-200 transition-all duration-200 p-4 h-full`}>
                                  {/* Service Header */}
                                  <div className="mb-3">
                                    <div className="flex items-start mb-2">
                                      ...
                                      <div>
                                        <h3 className="text-sm font-bold text-gray-900 leading-tight hover:text-blue-600 cursor-pointer"
                                  ...
                                  {/* Subservices Preview with "View All" Button */}
                                    ...
                                    <div className="mt-3">
                                      <div className="flex items-center justify-between mb-2">
                                        ...
                                        <button 
                                          ...
                                          onClick={(e) => {
                                            e.stopPropagation();
                                            setActiveSubDropdown(activeSubDropdown === service.id ? null : service.id);
                                          }}
                                        >
                                          {activeSubDropdown === service.id ? 'Hide' : 'View All'} →
                                        </button>
                                      </div>
                                      
                                      {/* Preview - First 2 subservices */}
                                      {activeSubDropdown !== service.id && (
                                        <div className="space-y-1.5">
                                          {service.subservices.slice(0, 2).map((subservice) => (
                                            <div
                                              key={subservice.id}
                                              className="flex items-start p-2 hover:bg-blue-50 rounded transition-colors cursor-pointer"
                                            ...
                                            >
                                              ...
                                              <div className="flex-1 min-w-0">
                                                <span className="block text-xs font-medium text-gray-800 hover:text-blue-600 truncate">
                                                  {subservice.name}
                                                </span>
                                              </div>
                                            </div>
                                          ...
                                          {service.subservices.length > 2 && (
                                            <button 
                                              className="w-full text-xs text-blue-600 hover:text-blue-700 font-medium mt-1 cursor-pointer"
                                              onClick={(e) => {
                                                e.stopPropagation();
                                                setActiveSubDropdown(service.id);
                                              }}
                                            >
                                              +{service.subservices.length - 2} more subservices
                                            </button>
                                          )}
                                        </div>
                                      )}
                                ...
                                {/* SUBITEMS DROPDOWN - 3 COLUMNS LAYOUT */}
                                {activeSubDropdown === service.id && service.subservices && service.subservices.length > 0 && (
                                  <div 
                                    ref={subDropdownRef}
                                    className="absolute left-0 right-0 top-full mt-2 bg-white shadow-2xl rounded-lg border border-gray-200 z-[101] overflow-hidden"
                                  ...
                                  >
                                    <div className="p-4">
                                      ...
                                      <div className="mb-4">
                                        ...
                                        <p className="text-gray-600 text-sm ml-5">{service.description}</p>
                                      </div>
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                          {service.subservices.map((subservice) => (
                                            <a
                                              ...
                                              className="bg-gray-50 hover:bg-blue-50 p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-150 group/subitem"
                                              onClick={(e) => {
                                                e.preventDefault();
                                            ...
                                            >
                                              <div className="flex flex-col h-full">
                                                ...
                                                <span className="block text-gray-600 text-xs ml-4 line-clamp-3">
                          ...
                          {item.subServices.map((service) => (
                            <div key={service.id} className="relative">
                              <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                ...
                                {/* Subservices for Mobile - Show All in 2 Columns */}
                                {service.subservices && service.subservices.length > 0 && (
                                  <div className="ml-4">
