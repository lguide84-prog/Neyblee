            ...
            <div className="space-y-4">
              {menuItems.map((item, index) => (
                <div key={index} className="border-b border-gray-100 pb-4 last:border-0">
                  <div 
                    className="flex items-center justify-between cursor-pointer py-3 hover:bg-gray-50 px-2 rounded-lg transition-colors"
                      ...
                      <div className="space-y-4">
                        {item.subServices.map((service, index) => (
                          <div key={service.id} className="pb-4 border-b border-gray-100 last:border-0">
                            {/* Service Header */}
                            <div 
                              className="cursor-pointer mb-2 p-2 hover:bg-gray-50 rounded transition-colors"
