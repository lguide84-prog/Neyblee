                ...
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    {item.hasDropdown && activeDropdown === item.title && (
                      <div 
                        className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[95vw] max-w-[1400px] bg-white shadow-2xl rounded-xl border border-gray-200 z-[100]"
                        style={{ height: '80vh' }}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                              {item.subServices.map((service, serviceIndex) => (
                                ...
                                >
                                  ...
                                  <div className="group cursor-pointer p-42 hover:bg-gray-50 rounded-lg transition-all duration-200 border border-transparent hover:border-gray-200">
                                    {/* Service Header */}
                                    <div 
                                      className="mb-3"
                                  ...
                                  {activeSubDropdown === service.id && service.subservices && service.subservices.length > 0 && (
                                    <div 
                                      ref={subDropdownRef}
                                      className="absolute left-0 top-full mt-1 bg-white shadow-2xl rounded-lg border border-gray-200 z-[101] overflow-hidden min-w-[500px]"
