            ...
            <div className="w-full max-w-6xl">
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="h-1/3 flex items-center justify-center w-full">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl font-bold text-white text-center drop-shadow-2xl leading-tight lg:leading-[4.5rem]">
                    FUTURE WITH
                  </h1>
                </div>
