...
const Connect = () => {
  ...
  const [topText, setTopText] = useState('Welcome to Our Website • Discover Amazing Things • Enjoy Your Stay • ');
  
  // State for the bottom marquee text
  const [bottomText, setBottomText] = useState('Let\'s Connect • Follow Us • Stay in Touch • Join Our Community • ');
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const topOptions = [
        'Welcome to Our Website • Discover Amazing Things • Enjoy Your Stay • ',
        'Creative Solutions • Innovative Ideas • Modern Design • Seamless Experience • ',
        'React Development • Tailwind CSS • Beautiful UI • Responsive Design • '
      ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white overflow-hidden">
      <div className="h-screen flex flex-col">
        ...
        <div className="h-1/2 relative overflow-hidden bg-gradient-to-r from-blue-900/30 to-purple-900/30">
              ...
              <div className="marquee-content h-full flex items-center">
                ...
                {[...Array(6)].map((_, index) => (
                  <div key={`top-${index}`} className="inline-flex items-center h-full">
                    <span className="text-7xl md:text-8xl lg:text-[40v] font-bold tracking-tighter whitespace-nowrap mx-8">
                      {topText}
                    </span>
                    {/* Separator icon */}
        ...
        <div className="h-1/2 relative overflow-hidden bg-gradient-to-r from-emerald-900/30 to-cyan-900/30">
          {/* Animated background elements */}
          <div className="absolute inset-0 opacity-10">
              ...
              <div className="marquee-content-reverse h-full flex items-center">
                ...
                {[...Array(6)].map((_, index) => (
                  <div key={`bottom-${index}`} className="inline-flex items-center h-full">
                    <span className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter whitespace-nowrap mx-8">
                      {bottomText}
                    </span>
                    {/* Separator icon */}
                    <span className="text-6xl mx-8">❖</span>
