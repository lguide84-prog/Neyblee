...
function Navbar({ isHomePage = false }) {
  ...
  return (
    <>
      ...
      <nav 
        className={`fixed top-6 left-4 right-4 z-50 transition-all duration-300 ${isScrolled ? 'shadow-xl bg-black backdrop-blur-sm rounded-full  ' : ''}`}
        ...
        <div className={`w-full px-6 py-4 lg:px-8 lg:py-4 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5'>
              ...
              <div className="hidden md:flex items-center space-x-5 exo text-lg big">
