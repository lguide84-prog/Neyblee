...
const Services = () => {
  ...
  // Handle hover with zoom animation
  const handleMouseEnter = (index) => {
    setHoveredIndex(index);
    
    if (imageContainerRef.current) {
      // Reset to initial small size
      ...
      // Animate to large size with zoom effect
      gsap.to(imageContainerRef.current, {
        ...
        ease: 'back.out(1.7)',
        onStart: () => {
          // Change image source when animation starts
      ...
      gsap.fromTo(
        imageContainerRef.current.querySelector('.image-overlay'),
        { y: 20, opacity: 0 },
        {
          y: 0,
          opacity: 1,
      ...
      <section className="pt-32 pb-20 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 px-6">
            ...
            >
              <TextRoll className="text-black big"  ref={textRef}>
                SERVICES
              </TextRoll>
            </h1>
          </div>
          ...
          {/* Floating Image with Zoom Animation */}
          <div 
          ...
          >
            <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
              ...
              />
              <div className="image-overlay absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">{hoveredIndex !== null ? services[hoveredIndex]?.title : ''}</h3>
                  <p className="text-sm opacity-90">{hoveredIndex !== null ? services[hoveredIndex]?.subtitle : ''}</p>
                </div>
              </div>
            </div>
          </div>
