        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-sm text-gray-700 hover:text-purple-600 transition-all duration-300 flex items-center group">
                  <svg className="w-3 h-3 mr-3 text-gray-500 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/services" className="text-sm text-gray-700 hover:text-purple-600 transition-all duration-300 flex items-center group">
                  <svg className="w-3 h-3 mr-3 text-gray-500 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/studio" className="text-sm text-gray-700 hover:text-purple-600 transition-all duration-300 flex items-center group">
                  <svg className="w-3 h-3 mr-3 text-gray-500 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/projects" className="text-sm text-gray-700 hover:text-purple-600 transition-all duration-300 flex items-center group">
                  <svg className="w-3 h-3 mr-3 text-gray-500 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/contact" className="text-sm text-gray-700 hover:text-purple-600 transition-all duration-300 flex items-center group">
                  <svg className="w-3 h-3 mr-3 text-gray-500 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
