...
function Home() {
  ...
  <div className="flex flex-row items-center gap-6">
    ...
    <a href="#" className="group relative">
      <div className="w-12 h-12 rounded-full flex items-center justify-center bg-green-500 transition-all duration-300 active:scale-90">
        <i className="fab fa-whatsapp text-white text-2xl"></i>
      </div>
      <span className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black/80 text-white px-2 py-1 rounded text-xs opacity-0 group-hover:opacity-100 transition-opacity">
        WhatsApp
      </span>
    </a>
