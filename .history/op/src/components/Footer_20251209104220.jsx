        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="max-w-xs space-y-5">
            ...
            <div className="flex space-x-3 pt-2">
              ...
              <a href="https://www.instagram.com/digitalexpressindia/?hl=en" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-700 transition-all duration-300 flex items-center justify-center group">
                <svg className="w-4 h-4 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
