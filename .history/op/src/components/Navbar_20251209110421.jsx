              ...
              <div className="hidden md:flex items-center space-x-5 text-lg big">
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    {/* Fixed Dropdown for SERVICES - SUBSERVICES IN 2 COLUMNS */}
                        ...
                        <div className="p-6">
                          ...
                          <div className="grid grid-cols-2 gap-6">
                            {item.subServices.map((service, serviceIndex) => (
                              ...
                              >
                                {/* Service Column */}
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 hover:border-gray-200 transition-all duration-200">
                                  {/* Service Header */}
                                  <a
                                    href={`/subservice/${service.id}/subservices`}
                                    className="block group/service-col"
                                  >
                                    ...
                                    <p className="text-gray-600 text-sm ml-6 mb-4">{service.description}</p>
                                  </a>
                                              ...
                                              <div key={i} className="grid grid-cols-3 gap-2">
                                                {rowItems.map((subservice, subIndex) => (
                                                  <a
                                                    ...
                                                    className="block p-2 bg-white hover:bg-blue-50 transition-all duration-150 rounded border border-gray-200 hover:border-blue-300 hover:shadow-sm group/subitem"
            ...
            <div className="w-full space-y-1">
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  {/* Submenu for SERVICES in overlay - 2 COLUMNS */}
                          ...
                          {item.subServices.map((service, serviceIndex) => (
                            <div key={service.id} className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                              ...
                              >
                                ...
                                <p className="text-gray-600 text-xs ml-5">{service.description}</p>
                              </div>
