...
function Navbar({ isHomePage = false }) {
  ...
  return (
    <>
      ...
      <nav 
        className={`fixed lg:top-6 left-2 right-2 lg:left-4 lg:right-4 z-50 transition-all duration-300 ${isScrolled ? 'shadow-xl bg-black backdrop-blur-sm rounded-full  ' : ''}`}
