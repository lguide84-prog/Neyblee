                ...
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    {item.hasDropdown && activeDropdown === item.title && !isMobile && (
                      <div 
                        className="fixed top-25 left-0 right-0 h-[80vh] bg-black/50 backdrop-blur-sm"
                      ...
                      >
                        <div className="absolute top-0 right-0 h-full w-[85%] max-w-[1000px] bg-white shadow-2xl">
                          ...
                          <button 
                            ...
                            className="absolute top- right-6 w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors z-10"
                          >
