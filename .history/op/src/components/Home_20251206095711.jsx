          ...
          <div className="hidden lg:flex lg:w-[10%] h-full flex-col items-center justify-start pt-30">
            <div className="flex flex-col items-center gap-8">
              ...
              <a 
                ...
                className="group"
              >
                <div className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 group-hover:border-white group-hover:bg-white/10 group-hover:-translate-y-2   duration-300 ease-out">
