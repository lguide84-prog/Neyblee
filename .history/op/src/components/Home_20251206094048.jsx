    ...
    <div className="w-full  h-[100vh] lg:py-4 lg:px-4">
      <div className="rounded-b-4xl lg:rounded-2xl w-full h-full flex flex-col relative overflow-hidden bg-black">
        ...
        <div className="flex flex-1 relative z-10 text-white flex-col-reverse lg:flex-row">
          <div className="w-[85%] h-[100vh] flex items-center justify-center">
    ...
    <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/10 to-transparent transform -translate-x-1/2"></div>
          ...
          <div className="w-[85%]  big">
            <div className="w-full h-full flex flex-col">
              {/* Top Row - 40% height */}
              <div className="h-[40%] flex items-end justify-center   bg-red-300">
...
<div className=" w-[15%]  flex-col justify-center flex">
