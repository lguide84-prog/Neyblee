...
function Navbar({ isHomePage = false }) {
  ...
  return (
    <>
      ...
      >
        <div className={`w-full py-4 lg:px-8 lg:py-2 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            {/* Logo/Brand Section */}
            <div className="flex items-center">
             <img src="/logo.jpg" className="h-19 w-19"/>
              <div className="flex flex-col">
                <span className="text-white font-bold text-lg tracking-wider">Digital Express<sup className="text-xs">®</sup></span>
