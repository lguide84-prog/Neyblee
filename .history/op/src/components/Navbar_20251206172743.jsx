          ...
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5'>
              ...
              >
                ...
                {/* Sub-Sub-Services Column - Modern Cards */}
                <div 
                  ref={subSubServicesRef}
                  className={`flex-1 bg-gradient-to-b from-gray-50 to-white overflow-y-auto p-6 transition-opacity duration-300 ${activeSubService ? 'opacity-100' : 'opacity-0'}`}
                >
                  {activeSubService && activeMainService && (
                    <>
                      <div className="mb-6">
                        <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                          <span className="font-medium">{activeMainService}</span>
                          <span>›</span>
                          <span className="font-medium">{activeSubService}</span>
                        </div>
                        <h2 className="text-2xl font-bold text-gray-800">{activeSubService}</h2>
                        <p className="text-gray-600 mt-2">Choose from our specialized services</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        {servicesData[activeMainService].subServices[activeSubService].map((item, index) => (
                          ...
                          >
                            <div className="bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-300 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                              <div className="flex items-start justify-between">
                                ...
                                <div className="ml-4 text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-200">
                        <button className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]">
                          Get Custom Quote
                        </button>
                      </div>
                    </>
