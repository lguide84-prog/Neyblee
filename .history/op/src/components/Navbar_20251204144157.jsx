  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className="relative h-[80vh] w-[45vw]  bg-gradient-to-br from-[#0A0A0A] via-[#111111] to-[#0A0A0A] rounded3xl overflow-hidden shadow-2xl transform-gpu border-l border-gray-700/50 "
          style={{
            transformOrigin: 'bottom right'
          }}
        >
