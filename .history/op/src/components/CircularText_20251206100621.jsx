...
const CircularText = ({
  ...
  className = '',
  showArrow = true,
  arrowSize = 'text-2xl', // Default size
  arrowClassName = '', // New prop for custom arrow styling
}) => {
        ...
        {showArrow && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative">
              ...
              <motion.div
                className={`${arrowSize} ${arrowClassName}`}
                whileHover={{ scale: 1.2 }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <i className="fa-light fa-arrow-down text-3xl text-white font-semibold"></i>
              </motion.div>
