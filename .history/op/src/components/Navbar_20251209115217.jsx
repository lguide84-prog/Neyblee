                ...
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    {item.hasDropdown && activeDropdown === item.title && (
                      <div 
                        className="absolute top-full -left-50 -translate-x-1/2 mt-2 w-[95vw] max-w-[1600px] bg-white shadow-2xl rounded-xl border border-gray-200 z-[100]"
                        style={{ height: '80vh' }}
                              ...
                              {item.subServices.map((service, serviceIndex) => (
                                ...
                                >
                                  ...
                                  {activeSubDropdown === service.id && service.subservices && service.subservices.length > 0 && (
                                    <div 
                                      ref={subDropdownRef}
                                      className="absolute left-0 -top-10 mt-1 bg-white shadow-2xl rounded-lg border border-gray-200 z-[101] overflow-hidden min-w-[500px]"
