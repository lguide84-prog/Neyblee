    ...
    <div className="w-full max-h-screen lg:h-[120vh] bg-[#F6F7F9] lg:py-4 lg:px-4">
      ...
      >
        ...
        <div className="flex flex-1 relative z-10  bg-red-300">
         ...
         <div className="w-[75%] flex flex-col justify-center items-center px-8 big">
  <div className="max-w-3xl w-full h-full flex flex-col">
    
    {/* Top Row - 40% height */}
    <div className="h-[40%] flex items-end justify-center pb-6 bg-amber-200">
      <h1 className="text-5xl md:text-8xl leading-tight md:leading-[4.5rem]  font-bold text-white drop-shadow-2xl">
       SHAPING THE
      </h1>
    </div>
    
    {/* Middle Row - 30% height */}
    <div className="h-[30%] flex items-center justify-center bg-amber-600">
       <h1 className="text-5xl md:text-7xl leading-tight md:leading-[4.5rem]  font-bold text-white drop-shadow-2xl">
    FUTURE WITH
      </h1>
    </div>
    
    {/* Bottom Row - 30% height */}
    <div className="h-[30%] flex items-start justify-center pt-6 bg-amber-950">
