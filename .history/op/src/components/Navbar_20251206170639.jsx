        ...
        <div className={`w-full py-4 lg:px-8 lg:py-4 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5'>
              ...
              {/* Services Card Dropdown - SIMPLE COLUMN DESIGN */}
              <div 
                ref={servicesCardRef}
                className="fixed top-20 z-50 hidden"
              ...
              >
                <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-300">
                  ...
                  <div className="bg-black p-4">
                    <h3 className="text-white font-bold text-lg text-center">SERVICES</h3>
                  </div>
                  ...
                  <div className="py-3">
                    {services.map((service, index) => (
                      <a
                        key={index}
                        href="#"
                        className="block px-6 py-3 text-gray-800 hover:bg-gray-100 border-b border-gray-100 last:border-b-0 transition-colors duration-200 font-medium"
                      >
                        {service}
                      </a>
                    ))}
