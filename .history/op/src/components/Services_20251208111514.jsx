    ...
    <div className="min-h-screen bg-white text-black" ref={servicesRef}>
      <section className="pt-32 pb-20 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Services List - Only Services, No Subservices */}
          <div className="space-y-6">
            {services.map((service, index) => (
              <div 
                key={service.id}
                className="service-item border-b border-gray-200"
                  ...
                  <div className="flex items-start w-full">
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="mt-4">
                        <span className="inline-flex items-center text-blue-600 font-medium group">
                          View {service.subservices.length} Subservices
                    ...
                    <div className="mr-2 w-12 flex-shrink-0 flex items-center justify-center">
                      <div className="h-8 w-8 lg:w-12 lg:h-12 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-black group-hover:bg-black">
                        <svg 
                          className="w-4 h-4 text-gray-500 group-hover:text-white transition-colors duration-300 group-hover:translate-x-1"
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
