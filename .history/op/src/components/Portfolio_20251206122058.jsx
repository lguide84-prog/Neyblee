...
const projectBoxes = [
  ...
  },
  {
    ...
    rightProject: {
      ...
      bgImage: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" // Film/cinema
    }
  }
];
    ...
    <>
      <div id="work" className=" bg-black rounded-[10vh]">
        ...
        <ReactLenis root>
          <main
            ref={container}
            className="relative flex w-full flex-col items-center justify-center pb-[30vh] lg:pb-[60vh] pt-[10vh] -mt-[20vh] lg:-mt-[50vh]"
          >
