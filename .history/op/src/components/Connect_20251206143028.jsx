    ...
    <div className="h-[88vh] bg-black text-[#292929] overflow-hidden relative">
      <div className="h-full flex flex-col">
        ...
        <div className="  flex items-center justify-center">
          ...
          <button className="fixed-button px-12 py-6 bg-[#111111] text-white exo lg:text-4xl hover:text-black hover:bg-white transition duration-500 font-medium rounded-full  ">
          Let's  Contact
          </button>
        </div>
