                ...
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    ...
                    {item.hasDropdown && activeDropdown === item.title && (
                      <div 
                        className="fixed top-0 left-0 right-0 h-screen bg-black/50 backdrop-blur-sm z-[100]"
                        ...
                        <div className="absolute top-0 right-0 h-full w-[85%] max-w-[1000px] bg-white shadow-2xl">
                          ...
                          <div className="h-full overflow-y-auto py-8 px-10">
                            ...
                            <div className="mb-8">
                              ...
                              <p className="text-gray-600 mt-2">Explore our comprehensive range of digital solutions</p>
                            </div>
                              ...
                              <div className="w-1/3">
                                <div className="space-y-6">
                                  {item.subServices.map((service, index) => (
                                    <div 
                                      key={service.id}
                                      className={`p-4 rounded-lg cursor-pointer transition-all duration-200 ${activeSubDropdown === service.id ? 'bg-blue-50 border-l-4 border-blue-500' : 'bg-gray-50 hover:bg-gray-100'}`}
                                    ...
                                    >
                                      ...
                                      <p className="text-gray-600 text-sm mt-2 ml-6">{service.description}</p>
                                ...
                                {item.subServices.find(service => service.id === 8) && (
                                  <div className="mt-8">
                                    <div 
                                      className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-5 rounded-xl cursor-pointer"
                                      onClick={(e) => handleServiceLinkClick(8, e)}
                                    >
                                      <div className="flex items-center justify-between">
                                        <div>
                                          <h3 className="text-xl font-bold">COMBO PACKAGES</h3>
                                          <p className="text-yellow-100 text-sm mt-1">Save up to 30% with bundled services</p>
                                        </div>
                            ...
                            <div className="mt-12 pt-8 border-t border-gray-200">
                              <div className="grid grid-cols-4 gap-4">
                                <div className="text-center">
                                  <div className="text-3xl font-bold text-blue-600">{item.subServices.length}+</div>
                                  <div className="text-gray-600 text-sm">Main Services</div>
                                </div>
                                <div className="text-center">
                                  <div className="text-3xl font-bold text-green-600">
                                    {item.subServices.reduce((total, service) => total + (service.subservices?.length || 0), 0)}+
                                  </div>
                                  <div className="text-gray-600 text-sm">Subservices</div>
                                </div>
                                <div className="text-center">
                            ...
                            <div className="mt-8">
                              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                                <div className="flex items-center justify-between">
                                  <div>
                                    <h3 className="text-xl font-bold text-gray-900">Need Help Choosing Services?</h3>
                                    <p className="text-gray-600 mt-1">Our experts will guide you to the perfect solution</p>
                                  </div>
                                  <button 
                                    onClick={() => setActiveDropdown(null)}
