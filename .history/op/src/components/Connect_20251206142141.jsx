    ...
    <div className="h-[88vh] bg-black text-[#292929] overflow-hidden relative">
      <div className="h-full flex flex-col">
        ...
        <div className="  flex items-center justify-center">
          ...
          <button className="fixed-button px-12 py-6 bg-[#111111] text-black text-2xl font-bold rounded-full hover:bg-gray-200 transition-all duration-300 shadow-2xl hover:shadow-white/50 transform hover:scale-105 uppercase ">
            Connect Now
          </button>
        </div>
