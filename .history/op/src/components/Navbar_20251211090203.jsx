...
function Navbar({ isHomePage = false }) {
  ...
  return (
    <>
      ...
      {/* MOBILE MENU OVERLAY - REMOVED CONDITIONAL RENDERING */}
      <div 
        ref={menuOverlayRef}
        className="fixed inset-0 bg-black/80 backdrop-blur-sm z-40 hidden items-end justify-end px-4 md:hidden"
      >
        <div 
