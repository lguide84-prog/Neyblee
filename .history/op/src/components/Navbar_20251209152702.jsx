...
function Navbar({ isHomePage = false }) {
  ...
  // NEW: Handle desktop click on Services
  const handleDesktopServicesClick = (e, item) => {
    ...
    // If mobile, let the default behavior handle it
  };
        ...
        <div className={`w-full py-1 lg:px-8 lg:py-1 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <img src="/logo.jpg" className="h-19 w-19 rounded-full" alt="Logo"/>
            ...
            <div className='flex items-center gap-5 relative' ref={dropdownRef}>
              <div className="hidden md:flex items-center space-x-5 text-lg big">
                {menuItems.slice(0, 4).map((item, index) => (
                  ...
                  >
                    <a 
                      href={item.href} 
                      className={`text-gray-300 font-medium tracking-wide hover:text-white magnet transition-colors duration-300 bg-[#383838] px-5 py-2 rounded-full ${item.title === 'HOME' ? 'text-white' : ''} inline-flex items-center justify-center min-w-[100px] relative z-10`}
                    ...
                    {item.hasDropdown && activeDropdown === item.title && !isMobile && (
                      <div 
                        className="fixed top-full left-0 right-0 bg-black/50 backdrop-blur-sm z-40"
                      ...
                      >
                        <div className="absolute top-4 right-28 w-[85%] max-w-[1000px] bg-white shadow-2xl rounded-xl overflow-hidden"
                          style={{
                              ...
                              <div className="w-1/3">
                                <div className="space-y-2">
                                  {item.subServices.map((service, index) => (
                                    <div 
                                      key={service.id}
                                      className={`p-3 rounded-lg cursor-pointer transition-all duration-200 ${activeSubDropdown === service.id ? 'bg-blue-50 border-l-2 border-blue-500' : 'bg-gray-50 hover:bg-gray-100'}`}
                                    ...
                                    <div className="h-full flex flex-col">
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                          {service.subservices.map((subservice) => (
                                            <a
                                              ...
                                              className="bg-gray-50 hover:bg-blue-50 p-3 rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 group"
                                              onClick={(e) => {
                                                e.preventDefault();
                                      ...
                                      <div className="mt-6 pt-6 border-t border-gray-200">
                                        <a 
                                          ...
                                          className="inline-flex items-center text-blue-600 hover:text-blue-700 font-bold text-lg"
                                          onClick={(e) => {
                                            e.preventDefault();
                                            handleViewAllClick(`/services/${service.id}`, e);
                                          }}
                                        >
                                          <span className="mr-3">View All {service.name} Services</span>
              ...
              <button 
                ...
                className="px-2 lg:px-5 py-2 text-white text-md font-medium rounded-full transition-all duration-300 shadow-lg hover:shadow-xl magnet relative z-20"
              >
                    ...
                    <div className="submenu overflow-hidden pl-6 mt-4">
                      <div className="border-l-2 border-gray-300 pl-6 pb-6">
                        ...
                        {item.subServices.find(service => service.id === 8) && (
                          <div className="mt-6">
                            <div 
                              className="cursor-pointer p-4 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg text-white"
