...
function Home() {
  ...
  <div className=" w-full h-full flex flex-col">
    ...
    {/* Top Row - 40% height */}
    <div className="h-[40%] flex items-end justify-center pb-4 bg-amber-200">
    ...
    <div className="h-[25%] flex items-center justify-center bg-amber-600">
       <h1 className="text-5xl md:text-9xl leading-tight md:leading-[4.5rem]  font-bold text-white drop-shadow-2xl">
    FUTURE WITH
      </h1>
    </div>
    ...
    <div className="h-[37%] flex items-start justify-center pt-6 bg-amber-950">
      <h1 className="text-5xl md:text-9xl leading-tight md:leading-[4.5rem]  font-bold text-white drop-shadow-2xl">
      SMART SOLUTIONS
      </h1>
    </div>
