  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className="relative h-[70vh] w-[45vw] bg-white  rounded-4xl overflow-hidden shadow-2xl transform-gpu "
          style={{
            transformOrigin: 'bottom right'
          }}
        >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative overflow-hidden p-0.5">
                      <h3 className="text-black font-extrabold text-5xl lg:text-7xl  exo tracking-tight opacity-90 text-xl group-hover:opacity-100 transition-all duration-500">
                        {item.title}
                      </h3>
                      {/* Underline animation */}
