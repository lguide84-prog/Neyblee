...
const Connect = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-500 overflow-hidden">
      <div className="h-screen flex flex-col">
        {/* Top Section - 50% height with marquee */}
        <div className="h-[4vh] relative overflow-hidden">
              ...
              <div className="marquee-content h-full flex items-center">
                ...
                {[...Array(6)].map((_, index) => (
                  <div key={`top-${index}`} className="inline-flex items-center h-full">
                    <span className="text-7xl md:text-8xl lg:text-[50vh] big  font-extrabold tracking-tighter whitespace-nowrap mx-8">
                      {topText}
                    </span>
                    {/* Separator icon */}
              ...
              <div className="marquee-content-reverse h-full flex items-center">
                ...
                {[...Array(6)].map((_, index) => (
                  <div key={`bottom-${index}`} className="inline-flex items-center h-full">
                    <span className="text-7xl md:text-8xl lg:text-[50vh] exo font-bold tracking-tighter whitespace-nowrap mx-8">
                      {bottomText}
                    </span>
                    {/* Separator icon */}
                    <span className="text-6xl mx-8">❖</span>
