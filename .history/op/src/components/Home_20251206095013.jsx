            ...
            <div className="w-full max-w-6xl">
              <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="h-1/3 flex items-end justify-center pb-4 lg:pb-8 w-full">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-8xl 2xl:text-9xl font-bold text-white text-center drop-shadow-2xl leading-tight lg:leading-[4.5rem]">
                    SHAPING THE
                  </h1>
                </div>
