                ...
                <div className="w-64 bg-gray-50 border-r border-gray-200 overflow-y-auto">
                  ...
                  <div className="py-2 ">
                    {mainServices.map((service, index) => (
                      <div
                        key={index}
                        className={`px-4 py-3 cursor-pointer transition-colors duration-200 ml-20border-l-4 ${activeMainService === service ? 'bg-blue-50 border-blue-500 text-blue-600' : 'border-transparent hover:bg-gray-100 text-gray-700'}`}
