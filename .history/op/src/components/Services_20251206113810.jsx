                ...
                >
                  <div className="flex items-start w-full">
                    ...
                    <div className="w-12 flex-shrink-0 flex items-center justify-center">
                      <div className={`w-18 h-14 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 group-hover:border-black ${expandedIndex === index ? 'bg-black border-black' : ''}`}>
                        <svg 
