    ...
    <div className="w-full max-h-screen lg:h-[120vh] bg-[#F6F7F9] lg:py-4 lg:px-4">
      ...
      >
        ...
        <div className="flex flex-1 relative z-10  bg-red-300">
          ...
          <div className="w-[20%] flex items-center justify-center bg-white">
          ...
          <div className="w-3.3/5 flex flex-col justify-center items-center px-8">
          ...
          <div className="w-0.7/5 flex items-center justify-center bg-white">
            <div className="text-white text-center">
