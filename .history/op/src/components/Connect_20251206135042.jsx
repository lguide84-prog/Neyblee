...
const Connect = () => {
  ...
  return (
    <div className="relative w-full bg-black overflow-hidden min-h-screen flex items-center justify-center">
      ...
      {/* Center Button - Fixed on top with z-50 */}
      <div ref={textRef} className="relative z-50 text-center">
        <button
          ref={buttonRef}
          className="group bg-white text-black px-16 py-6 rounded-full flex items-center gap-6 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-95"
        >
      ...
      {/* Gradient Overlays - Below button */}
      ...
      <div className="absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-black to-transparent z-40"></div>
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-black to-transparent z-40"></div>
