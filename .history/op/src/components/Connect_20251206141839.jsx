  ...
  return (
    <div className="h-[88vh] bg-black text-[#292929] overflow-hidden relative">
      <div className="h-full flex flex-col">
        ...
        <div className="h-[48vh] relative overflow-hidden">
        ...
        <div className="h-[12vh] relative flex items-center justify-center">
          {/* Center Button with higher z-index and proper positioning */}
          <button className="fixed-button px-12 py-6 bg-white text-black text-2xl font-bold rounded-full hover:bg-gray-200 transition-all duration-300 shadow-2xl hover:shadow-white/50 transform hover:scale-105 uppercase tracking-wider z-50">
            Connect Now
          </button>
        </div>
