    ...
    <div className="sticky -top-[10vh] lg:-top-30 flex items-center justify-center">
      ...
      >
        <div className="w-full h-full flex flex-col lg:flex-row gap-4 lg:gap-8">
          ...
          {/* Left Card - Typography Heavy */}
          <a 
            href={leftProject.link} 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex-1 group relative bg-black border border-white/10 hover:border-white/30 transition-all duration-500 overflow-hidden"
          >
            {/* Text Background Pattern */}
            <div className="absolute inset-0 opacity-5">
              <div className="absolute top-1/4 left-1/4 text-6xl font-black">◼</div>
              <div className="absolute bottom-1/4 right-1/4 text-6xl font-black">◼</div>
            </div>

            {/* Corner Accents */}
            <div className="absolute top-4 left-4 w-2 h-2 bg-white"></div>
            <div className="absolute top-4 right-4 w-2 h-2 bg-white"></div>
            ...
            <div className="relative h-full p-8 flex flex-col justify-between">
              {/* Vertical Title */}
              <div className="absolute top-8 left-8 -rotate-90 origin-top-left">
              ...
              <div className="ml-16">
                <div className="mb-2">
                  <span className="text-white/40 text-sm">{leftProject.year}</span>
                </div>
                
                <div className="space-y-0">
                  <h3 className="text-white text-5xl lg:text-6xl font-black tracking-tighter leading-none">
                    {leftProject.title}
                  </h3>
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                <div className="text-white text-sm group-hover:underline">
                  EXPLORE
                </div>
              </div>
            </div>
          ...
          >
            <div className="absolute inset-0 opacity-5">
              <div className="absolute top-1/3 left-1/3 text-6xl font-black">◼</div>
              <div className="absolute bottom-1/3 right-1/3 text-6xl font-black">◼</div>
            </div>
            ...
            <div className="relative h-full p-8 flex flex-col justify-between">
              ...
              <div className="ml-16">
                <div className="mb-2">
                  <span className="text-white/40 text-sm">{rightProject.year}</span>
                </div>
