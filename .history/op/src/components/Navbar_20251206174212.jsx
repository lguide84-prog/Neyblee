...
function Navbar({ isHomePage = false }) {
  ...
  const handleMenuClick = () => {
    ...
    setActiveDropdown(null); // Close dropdown when menu opens/closes
        ...
        <div className={`w-full py-4 lg:px-8 lg:py-4 ${isHomePage ? 'bg-transparent' : 'bg-black'} rounded-full transition-all duration-300 ${isScrolled ? 'scale-[0.98]' : ''}`}>
          <div className="flex items-center justify-between">
            ...
            <div className='flex items-center gap-5 relative' ref={dropdownRef}>
              {/* Desktop Navigation Links - Using first 4 items */}
                  ...
                  >
                    ...
                    >
                      <TextRoll className="text-center">
                        {item.title}
                        {item.hasDropdown&& (
                          <span className="ml-2 text-xs">ok</span>
                        )}
                      </TextRoll>
                    </a>
                    ...
                    {item.hasDropdown && activeDropdown === item.title && (
                      <div 
                        className="absolute top-full left-0 mt-2 w-64 bg-black/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-800 overflow-hidden z-50"
      ...
      >
        ...
        >
          ...
          <div className="h-full flex flex-col justify-start items-center px-4 lg:px-12 pt-20 pb-10">
            {/* Menu Items - Using all items with numbers */}
