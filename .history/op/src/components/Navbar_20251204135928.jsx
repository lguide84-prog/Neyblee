...
function Navbar() {
  return (
    <nav className="w-full px-6 py-2 lg:px-8 lg:py-6 bg-black rounded-full">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-10">
          <a 
            href="#" 
            className="text-white font-medium text-sm tracking-wide hover:text-blue-300 transition-colors duration-300 relative group"
          >
            HOME
          ...
          <a 
            href="#" 
            className="text-gray-300 font-medium text-sm tracking-wide hover:text-white transition-colors duration-300 relative group"
          >
            STUDIO
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-400 group-hover:w-full transition-all duration-300"></span>
          </a>
